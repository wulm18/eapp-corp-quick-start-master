...
public class URLConstant {
     ...
     * 发送普通消息
     */
    public static final String URL_SENT_MESSAGE ="https://oapi.dingtalk.com/chat/send";
    /**
     * 上传媒体文件,获取mediaId
     */
    public static final String URL_SENT_MEDIA ="https://oapi.dingtalk.com/media/upload";
}
